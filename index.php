                    ...
                    <div class="col-md-4 col-sm-12 col-custom">
                        <div class="banner-image hover-style">
                            <a class="d-block" href="#">
                                <img class="w-100" src="assets/images/banner/small-banner/2.1.png" alt="Banner Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-custom">
                        <div class="banner-image hover-style">
                            <a class="d-block" href="#">
                                <img class="w-100" src="assets/images/banner/small-banner/2.2.png" alt="Banner Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-custom">
                        <div class="banner-image hover-style mb-0">
                            <a class="d-block" href="#">
                                <img class="w-100" src="assets/images/banner/small-banner/2.3.png" alt="Banner Image">
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        "slidesToShow": 1
                            ...
                            <div class="single-item">
                                <div class="single-product position-relative">
                                    <div class="product-image">
                                        <a class="d-block" href="#">
                                            <img src="assets/images/product/p-1.png" alt="" class="product-image-1 w-100  h-75 object-fit-contain">
                                            <img src="assets/images/product/p-1.png" alt="" class="product-image-2 position-absolute w-100">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="#">Product dummy name</a></h4>
                                        </div>
                                        <div class="price-box">
                            ...
                            <div class="single-item">
                                <div class="single-product position-relative">
                                    <div class="product-image">
                                        <a class="d-block" href="#">
                                            <img src="assets/images/product/p-2.png" alt="" class="product-image-1 w-100">
                                            <img src="assets/images/product/p-2.png" alt="" class="product-image-2 position-absolute w-100">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <div class="product-rating">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="#">Product dummy title</a></h4>
                                        </div>
                                        <div class="price-box">
                                            <span class="regular-price ">$80.00</span>
                                            <span class="old-price"><del>$90.00</del></span>
                            ...
                            <div class="single-item">
                                <div class="single-product position-relative">
                                    <div class="product-image">
                                        <a class="d-block" href="#">
                                            <img src="assets/images/product/p-3.png" alt="" class="product-image-1 w-100">
                                            <img src="assets/images/product/p-3.png" alt="" class="product-image-2 position-absolute w-100">
                                        </a>
                                    </div>
                            ...
                            <div class="single-item">
                                <div class="single-product position-relative">
                                    <div class="product-image">
                                        <a class="d-block" href="#">
                                            <img src="assets/images/product/p-1.png" alt="" class="product-image-1 w-100">
                                            <img src="assets/images/product/p-1.png" alt="" class="product-image-2 position-absolute w-100">
                                        </a>
                                    </div>
                                    <div class="product-content">
                        ...
                        "slidesToShow": 1
                            ...
                            <div class="single-blog">
                                <div class="single-blog-thumb">
                                    <a href="#">
                                        <img src="assets/images/product/p-1.png" alt="Blog Image">
                                    </a>
                                </div>
                                <div class="single-blog-content position-relative">
                                    ...
                                    <h2 class="post-title">
                                        <a href="#">There Are Many Variation of Passages of Lorem Ipsum Available</a>
                                    </h2>
                            ...
                            <div class="single-blog">
                                <div class="single-blog-thumb">
                                    <a href="#">
                                        <img src="assets/images/product/p-2.png" alt="Blog Image">
                                    </a>
                                </div>
                                <div class="single-blog-content position-relative">
                                    <div class="post-date text-center border rounded d-flex flex-column position-absolute">
                            ...
                            <div class="single-blog">
                                <div class="single-blog-thumb">
                                    <a href="#">
                                        <img src="assets/images/product/p-3.png" alt="Blog Image">
                                    </a>
                                </div>
                                <div class="single-blog-content position-relative">
                                    <div class="post-date text-center border rounded d-flex flex-column position-absolute">
